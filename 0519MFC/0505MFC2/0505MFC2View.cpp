...
BEGIN_MESSAGE_MAP(CMy0505MFC2View, CRecordView)
	...
	ON_BN_CLICKED(IDC_BUTTON1, &CMy0505MFC2View::OnBnClickedButton1)
	ON_BN_CLICKED(IDC_BUTTON3, &CMy0505MFC2View::OnBnClickedButton3)
END_MESSAGE_MAP()
...
void CMy0505MFC2View::OnBnClickedButton2()
{
	// TODO: 在此添加控件通知处理程序代码
	m_pSet->Delete();
	if (m_pSet->IsBOF())
...
void CMy0505MFC2View::OnBnClickedButton1()
{
	// TODO: 在此添加控件通知处理程序代码
	add_dlg dlg;
	int r = dlg.DoModal();
...
void CMy0505MFC2View::OnBnClickedButton3()
{
	// TODO: 在此添加控件通知处理程序代码
	add_dlg dlg;
